...
module.exports = {
  ...
  ANALYTICS_VERCEL_SPEED_INSIGHTS: process.env.NEXT_PUBLIC_ANALYTICS_VERCEL_SPEED_INSIGHTS || true, // 3-11-2025 Vercel Speed Insights性能分析 https://vercel.com/docs/concepts/speed-insights
